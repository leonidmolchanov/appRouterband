(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("util"), require("net"), require("domain"), require("crypto"), require("events"));
	else if(typeof define === 'function' && define.amd)
		define(["util", "net", "domain", "crypto", "events"], factory);
	else if(typeof exports === 'object')
		exports["MikroNode"] = factory(require("util"), require("net"), require("domain"), require("crypto"), require("events"));
	else
		root["MikroNode"] = factory(root["util"], root["net"], root["domain"], root["crypto"], root["events"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_374__, __WEBPACK_EXTERNAL_MODULE_379__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _simpleAssign3 = __webpack_require__(1);

	var _simpleAssign4 = _interopRequireDefault(_simpleAssign3);

	var _simpleAssign = __webpack_require__(1);
	...
	var _coreDecorators = __webpack_require__(355);

	var _crypto = __webpack_require__(374);
	...
	var _parser = __webpack_require__(377);

	var _parser2 = _interopRequireDefault(_parser);

	var _Connection = __webpack_require__(378);
	...
	var MikroNode = function () {
	    ...
	    _createClass(MikroNode, [{
	        ...
	        key: 'connect',
	        value: function connect(user, password) {
	            var _this = this;
	            ...
	            _sock.set(this, new SocketStream(_timeout.get(this), _debug.get(this)));

	            var stream = _sock.get(this).getStream();

	            var login = function login(challenge) {
	            ...
	            var promise = new _promise2.default(function (resolve, reject) {
	                var connected = function connected() {
	                    ...
	                    stream.write('/login');
	                    _this.connection = new _Connection2.default(_extends({}, stream, { close: close }), login, { resolve: resolve, reject: reject });
	                    _this.connection.setDebug(_debug.get(_this));
	                    /* Initiate Login */
	                };
	                _debug.get(_this) >= _constants.DEBUG.SILLY && console.log('Connecting to remote host');
	                _sock.get(_this).connect(_host.get(_this), _port.get(_this), connected);
	                _sock.get(_this).getStream().sentence.subscribe(null, reject, null); // reject promise on error.
	            });
	...
	exports.default = (0, _simpleAssign2.default)(api, { CONNECTION: _constants.CONNECTION, CHANNEL: _constants.CHANNEL, EVENT: _constants.EVENT, resultsToObj: _Util.resultsToObj });
	...
	var SocketStream = (_class = function () {
	    function SocketStream(timeout, debug) {
	        var _this2 = this;
	        ...
	        _socket.set(this, new Socket({ type: 'tcp4' }));

	        _sentence$.set(this, new _rxjs.Subject());
	        // Each raw sentence from the stream passes through this parser.


	        _parsed$.set(this, _sentence$.get(this).map(function (o) {
	            return o.join('\n');
	        }) // Make array string.
	        .do(function (d) {
	            return _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Data to parse:", d);
	        }).map(function (d) {
	            var s = _parser2.default.parse(d);s.host = _this2.host;return s;
	        }).flatMap(function (d) {
	        ...
	        _data$.get(this).scan(function (last, stream, i) {
	            var buff = Buffer.concat([last.b, stream]),
	                l = last.len,
	                o = last.o,
	                c = void 0,
	                go = void 0;

	            _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log("Packet received: ", last, stream);
	            // If the xpected length of lst process is zero, we expect to be told next buffer length.
	            if (!last.len) {
	                // Getting length;
	                _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Getting length");

	                var _decodeLength = (0, _Util.decodeLength)(buff);

	                var _decodeLength2 = _slicedToArray(_decodeLength, 2);

	                buff = _decodeLength2[0];
	                l = _decodeLength2[1];

	                _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Length: ", l);
	                // We didn't get all of the data from this buffer. Wait for next packet.
	                if (buff.length < l) {
	                    _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log("Buffer shorter than expected data, waiting for next packet.", { b: buff, len: l, o: o });
	                    return { b: buff, len: l, o: o };
	                }
	            }
	            go = buff.length > 0;
	            _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Starting parse loop w/existing length ", l);
	            while (go) {
	                c = buff.slice(0, l).toString('utf8');
	                _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Extracted data: ", c);
	                // Push content as sentence piece.
	                o.push(c);
	                // If we detected end of sentence
	                if (buff[l] === 0) {
	                    // then post new sentence.
	                    _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log('Detected end of sentence, posting existing sentence', o);
	                    _sentence$.get(_this2).next(o);
	                    // Reset sentence buffer.
	                    l++;
	                    o = [];
	                }
	                _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Getting length", buff.slice(l));

	                var _decodeLength3 = (0, _Util.decodeLength)(buff.slice(l));

	                var _decodeLength4 = _slicedToArray(_decodeLength3, 2);

	                buff = _decodeLength4[0];
	                l = _decodeLength4[1];

	                _debug2.get(_this2) >= _constants.DEBUG.SILLY && console.log("Length", l);
	                if (!l) {
	                    _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log('End of data, nothing left to process');
	                    go = false;
	        ...
	        }, { b: Buffer.from([]), len: 0, o: [] }).subscribe(function (e) {
	            return _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log('Buffer leftover: ', e.len ? e : 'Empty');
	        ...
	        var closeSocket = function closeSocket(e) {
	            _debug2.get(_this2) >= _constants.DEBUG.DEBUG && console.log("Closing Socket ", e);e ? _socket.get(_this2).destroy(e) : _socket.get(_this2).destroy();
	        };
	    ...
	    _createClass(SocketStream, [{
	        ...
	        value: function setTimeout(timeout) {
	            ...
	            _socket.get(this).setTimeout(timeout * 10000, function (e) {
	        ...
	        key: 'connect',
	        value: function connect(host, port, cb) {
	            var _this4 = this;

	            _debug2.get(this) >= _constants.DEBUG.DEBUG && console.log('SocketStream::Connect', [host, port, cb]);

	            _status2.set(this, _constants.CONNECTION.CONNECTING);

	            this.host = host;
	            _socket.get(this).connect(port, host, function () {
	                _debug2.get(_this4) >= _constants.DEBUG.INFO && console.log('Socket Connected');
	        ...
	        value: function write(data, args) {
	            ...
	            if (args && (typeof args === 'undefined' ? 'undefined' : _typeof(args)) === _typeof({})) {
	                _debug2.get(this) >= _constants.DEBUG.SILLY && console.log("Converting obj to args", obj);
	                data = data.concat((0, _Util.objToAPIParams)(args, data[0].split('/').pop()));
	            }
	            ...
	            data.forEach(function (i) {
	                try {
	                    _debug2.get(_this5) >= _constants.DEBUG.DEBUG && console.log('write: sending ' + i);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmptyError_1 = __webpack_require__(207);
	...
	var VirtualTimeScheduler_1 = __webpack_require__(350);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var cache_1 = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var combineAll_1 = __webpack_require__(153);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var mergeMap_1 = __webpack_require__(160);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var concatMapTo_1 = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var mergeMapTo_1 = __webpack_require__(163);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var count_1 = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var dematerialize_1 = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var debounce_1 = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var debounceTime_1 = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var defaultIfEmpty_1 = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var delay_1 = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var delayWhen_1 = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var distinct_1 = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var distinctKey_1 = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var distinctUntilKeyChanged_1 = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var exhaust_1 = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var exhaustMap_1 = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var elementAt_1 = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var finally_1 = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var mapTo_1 = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(17);
	var max_1 = __webpack_require__(234);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AsapScheduler_1 = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubscriptionLog_1 = __webpack_require__(347);
	var VirtualTimeScheduler_1 = __webpack_require__(350);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Observable_1 = __webpack_require__(17);
	var Subscription_1 = __webpack_require__(23);
	var SubscriptionLoggable_1 = __webpack_require__(346);
	var applyMixins_1 = __webpack_require__(348);
	/**
	 * We need this JSDoc comment for affecting ESDoc.
	 * @ignore
	 * @extends {Ignored}
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var AnimationFrameAction_1 = __webpack_require__(352);
	var AnimationFrameScheduler_1 = __webpack_require__(354);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _applyDecorators = __webpack_require__(373);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _privateUtils = __webpack_require__(357);
	  ...
	  function peg$parse(input, options) {
	    ...
	    var peg$FAILED = {},
	      ...
	      return { type: "data", data: data, tag: tag };
	        ...
	        peg$c2 = function peg$c2(data, tag) {
	      return { type: "data", data: data, tag: tag };
	    },
	        peg$c3 = function peg$c3(data) {
	      return { type: "data", data: data };
	    },
	        peg$c4 = function peg$c4(e) {
	      return e;
	    },
	        peg$c5 = "!re",
	      ...
	      return "";
	        ...
	        peg$c8 = function peg$c8(id, value) {
	      return { field: id, value: value };
	        ...
	        peg$c13 = function peg$c13(id) {
	      return id.join('');
	    },
	        peg$c14 = /^[^\r\n\0]/,
	        peg$c15 = peg$classExpectation(["\r", "\n", "\0"], true, false),
	        peg$c16 = function peg$c16(v) {
	      return v.join('');
	    },
	        peg$c17 = /^[\r\n\0]/,
	        peg$c18 = peg$classExpectation(["\r", "\n", "\0"], false, false),
	        peg$c19 = function peg$c19(v) {
	      return '';
	    },
	        peg$c20 = function peg$c20(f) {
	      return { type: "fatal", data: f };
	    },
	        peg$c21 = function peg$c21(t) {
	      return t;
	    },
	        peg$c22 = "!done",
	        ...
	        peg$c28 = function peg$c28(ret) {
	      return { type: "done_ret", data: ret.join('') };
	    },
	        peg$c29 = function peg$c29(tag, ret) {
	      return { type: "done_ret", tag: tag, data: ret.join('') };
	    },
	        peg$c30 = function peg$c30(tag) {
	      return { type: "done_tag", tag: tag };
	    },
	        peg$c31 = function peg$c31() {
	      return { type: "done" };
	    },
	        peg$c32 = function peg$c32(tag) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Channel = __webpack_require__(380);
	...
	var Connection = (_class = function (_events$EventEmitter) {
	    ...
	    function Connection(stream, loginHandler, p) {
	        ...
	        login.filter(function (d) {
	            ...
	            _debug.get(_this) >= _constants.DEBUG.INFO && console.log('Connected');
	            p.resolve(_this);
	        ...
	        stream.read.subscribe(null, null, function (e) {
	            return _channels.get(_this).forEach(function (c) {
	                return c.complete();
	            });
	        });
	        return _this;
	    ...
	    _createClass(Connection, [{
	        ...
	        key: 'closeOnDone',
	        value: function closeOnDone(b) {
	            if (b) _closeOnDone.set(this, b);else return _closeOnDone.get(this);
	            return this;
	        }
	    }, {
	        key: 'getChannel',
	        ...
	        key: 'openChannel',
	        value: function openChannel(id) {
	            var _this2 = this;

	            var closeOnDone = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
	            ...
	            var s = {
	                ...
	                "close": function close() {
	                    ...
	                    if (channel) {
	                        ...
	                        if (_channels.get(_this2).length == 0 && _closeOnDone.get(_this2)) _this2.close();
	                ...
	                "done": function done() {
	                    ...
	                    if (_closeOnDone.get(_this2)) {
	                        var cl = _channels.get(_this2).filter(function (c) {
	                            return c.status & (_Channel2.default.OPEN | _Channel2.default.RUNNING);
	                        });
	                        if (cl.length) return false;
	                        _channels.get(_this2).filter(function (c) {
	                            return c.status & _Channel2.default.DONE;
	                        }).forEach(function (c) {
	...
	var Channel = function (_events$EventEmitter) {
	    ...
	    **/
	    function Channel(id, stream, debug, closeOnDone) {
	        ...
	        _debug.get(_this) & _constants.DEBUG.SILLY && console.log('Channel::New');

	        _closeOnDone.set(_this, closeOnDone);
	        // if(this.status&(CHANNEL.CLOSING|CHANNEL.CLOSED)) return;


	        var done = new _rxjs.Subject();
	        var index = done.subscribeOn(_rxjs.Scheduler.async).scan(function (idx, i) {
	            return ++idx;
	        }, 0).share(); // share the index result.

	        _stream.set(_this, stream);

	        _id.set(_this, id);

	        _read.set(_this, stream.read.takeWhile(function () {
	            return !(_status.get(_this) & (_constants.CHANNEL.CLOSING | _constants.CHANNEL.CLOSED));
	        }).do(function (e) {
	            _debug.get(_this) >= _constants.DEBUG.DEBUG && console.log('Channel (%s)::Event (%s)', id, e.type);
	            if (e.type == _constants.EVENT.DONE_TAG || e.type == _constants.EVENT.DONE || e.type == _constants.EVENT.DONE_RET) {
	                _debug.get(_this) >= _constants.DEBUG.DEBUG && console.log('Channel (%s)::Triggering Done', id);

	                _status.set(_this, _constants.CHANNEL.DONE);

	                if (_closeOnDone.get(_this)) {
	                    _status.set(_this, _constants.CHANNEL.CLOSING);

	                    _debug.get(_this) >= _constants.DEBUG.DEBUG && console.log('Channel (%s)::CLOSING', id);
	                }
	                done.next("go");
	            } else if (e.type == _constants.EVENT.TRAP && _closeOnTrap.get(_this)) {
	                _status.set(_this, _constants.CHANNEL.CLOSING);

	                _debug.get(_this) >= _constants.DEBUG.DEBUG && console.log('Channel (%s)::CLOSING', id);
	                done.complete();
	                _this.close();
	            } else if (e.type == _constants.EVENT.FATAL) {
	                _status.set(_this, _constants.CHANNEL.CLOSED);

	                _debug.get(_this) >= _constants.DEBUG.INFO && console.log('Channel (%s)::CLOSING', id);
	                done.complete();
	                _this.close();
	            }
	        }));
	        ...
	        _trap.set(_this, _read.get(_this).filter(function (e) {
	            return e.type === _constants.EVENT.TRAP_TAG || e.type === _constants.EVENT.TRAP;
	        }));

	        _data.set(_this, _read.get(_this).filter(function (e) {
	            return e.type === _constants.EVENT.DATA || e.type === _constants.EVENT.DONE_RET;
	        }).do(function (e) {
	            return _debug.get(_this) >= _constants.DEBUG.DEBUG && console.log('Channel (%s)::DATA ', id, e);
	        }).do(function (data) {
	            return _this.emit(_constants.EVENT.DATA, data.data);
	        }));

	        _bufferedStream.set(_this, _data.get(_this).buffer(index).map(function (d) {
	            return { id: id, type: _constants.EVENT.DONE, data: d.map(function (d) {
	                    return d.data;
	                }) };
	        }));
	        // .combineLatest(index,(buffer,index)=>({...buffer,index}));

	        _bufferedStream.get(_this).subscribe(function (buffer) {
	            _debug.get(_this) >= _constants.DEBUG.INFO && console.log('Channel(%s)::DONE', id);
	            _this.emit(_constants.EVENT.DONE, buffer);
	            // Check command buffer, if it has items, flush them.
	            if (_buffer.get(_this).length == 0 && _status.get(_this) & _constants.CHANNEL.CLOSING || _closeOnDone.get(_this) || _stream.get(_this).done()) {
	                _debug.get(_this) >= _constants.DEBUG.SILLY && console.log("Channel (%s) closing", id);
	                _this.close();
	            }
	        });

	        index.flatMapTo(_rxjs.Observable.using(function () {
	            return _buffer.get(_this);
	        }, function (r) {
	            if (_sync.get(_this)) {
	                if (_buffer.get(_this).length) {
	                    return _rxjs.Observable.of(_buffer.get(_this).shift());
	                } else return _write.get(_this).take(1);
	            } else return _write.get(_this);
	            ...
	            _status.set(_this, _constants.CHANNEL.RUNNING);

	            _debug.get(_this) >= _constants.DEBUG.INFO && console.log("Writing on channel %s", _id.get(_this), d, args);
	            _stream.get(_this).write(d, args);
	            return _this;
	        });
	        _write.get(_this).subscribe(function (_ref3) {
	            var _ref4 = _slicedToArray(_ref3, 2);

	            var d = _ref4[0];
	            var args = _ref4[1];

	            if (_status.get(_this) & _constants.CHANNEL.RUNNING && _sync.get(_this)) _buffer.get(_this).push([d, args]);else _stream.get(_this).write(d, args);
	        });
	        return _this;
	    }
	    ...
	    **/
	    ...
	    _createClass(Channel, [{
	        key: 'write',
	        value: function write(d, args) {
	            if (_status.get(this) & (_constants.CHANNEL.CLOSED | _constants.CHANNEL.CLOSING)) {
	                _debug.get(this) >= _constants.DEBUG.WARN && console.log("Cannot write on closed or closing channel");
	                return this;
	            }
	            _write.get(this).next([d, args]);
	        }
	        ...
	        value: function close(force) {
	            if (_status.get(this) & _constants.CHANNEL.RUNNING) {
	                if (force) _stream.get(this).write('/cancel');
	                // else this.write('/cancel');
	                _closeOnDone.get(this)(true);
	        ...
	        value: function pipeFrom(stream$) {
	            ...
	            if (_status.get(this) & (_constants.CHANNEL.DONE | _constants.CHANNEL.OPEN)) {
	                ...
	                stream$.subscribe(function (d) {
	                    return _write.get(_this2)(d);
	                }, function () {
	                    _status.set(_this2, _constants.CHANNEL.DONE);

	                    _stream.get(_this2).done();
	                }, function () {
	                    _status.set(_this2, _constants.CHANNEL.DONE);
	        ...
	        key: 'closeOnDone',
	        value: function closeOnDone(b) {
	            return _closeOnDone.set(this, b);
	        }
	        ...
	        key: 'closeOnTrap',
	        value: function closeOnTrap(b) {
	            return _closeOnTrap.set(this, b);
	        }
	    }, {
	        key: 'data',
	        get: function get() {
